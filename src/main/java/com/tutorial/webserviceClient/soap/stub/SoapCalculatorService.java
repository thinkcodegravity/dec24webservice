 ...
 * 
 */
@WebServiceClient(name = "SoapCalculatorService", targetNamespace = "http://soap.webservice.tutorial.com/", wsdlLocation = "http://localhost:7070/math?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:7070/math?wsdl");
